...
class Car {
    ...
    public Car(String name) {
        ...
        System.out.println("FirstChapter.Car name :" + this.name);
    }
    ...
    public Car(String name, double price) {
        ...
        System.out.println("FirstChapter.Car name :" + this.name + ", price:" + this.price);
    }

    // method
    void run() {
        System.out.println(name + " FirstChapter.Car is running...");
    }
}
...
public class Sample {
    ...
    public static void main(String[] args) {
        ...
        // Create object with 1 parameter FirstChapter.Car(String name)
